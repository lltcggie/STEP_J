	...
	*/
	...
	/*!
		...
		\param	pParentWnd	Points to the parent or owner window object (of
							...
							If it is NULL, the dialog object痴 parent window
...
<code><pre>
	...
	*/
	...
	/*!
		...
		Call this member function to retrieve the option sheet window痴
	...
	*/
	...
	/*!
		...
		after the dialog is open; you can稚 call SetWizardButtons before you
	...
	*/
	...
	/*!
		...
		<b>AddPage</b> adds the COptionPage object to the COptionSheet object痴
	...
	*/
	...
	/*!
		...
		<b>AddGroup</b> adds the COptionPage object to the COptionSheet object痴
...
private:
	...
	*/
	void AddButton(TCHAR *txt, int x, int w, UINT id, BOOL showBut = TRUE);
