...
const bmff::EnumLanguageCode::Entry bmff::EnumLanguageCode::data[] = {
    ...
    { mp4v2::impl::bmff::ILC_NOB,  "nob",  "Bokm奪l, Norwegian; Norwegian Bokm奪l" },
    ...
    { mp4v2::impl::bmff::ILC_OCI,  "oci",  "Occitan (post 1500); Proven巽al" },
    ...
    { mp4v2::impl::bmff::ILC_PRO,  "pro",  "Proven巽al, Old (to 1500)" },
    ...
    { mp4v2::impl::bmff::ILC_VOL,  "vol",  "Volap端k" },
